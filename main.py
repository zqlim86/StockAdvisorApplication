...
def stockPrediction(ticker):
    ...
    api_key = "2637bc10cb03bb780927e542ee64dc35"
    ...
    # Evaluate the model
    loss, mae, rmse = model.evaluate(test_X, test_Y, verbose=0)
    ...
    # Use the last 30 days of data to predict the next day's price
